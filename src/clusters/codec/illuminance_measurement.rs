//! Generated Matter TLV encoders and decoders for Illuminance Measurement Cluster
//! Cluster ID: 0x0400
//! 
...
pub fn decode_light_sensor_type(inp: &tlv::TlvItemValue) -> anyhow::Result<Option<u8>> {
    if let tlv::TlvItemValue::Int(v) = inp {
        Ok(Some(*v as u8))
    } else {
        Ok(None)
