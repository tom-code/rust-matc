...
* create CA certificates in directory pem: `cargo run --example demo ca-bootstrap`
* create key/certificate for controller with id 100: `cargo run --example demo ca-create-controller 100`
* commission device (device ip address is 192.168.5.70, commissioning passcode is 123456, device is will be 300, device admin has id 100):
